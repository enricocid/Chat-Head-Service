...
class viewUtils {
    ...
    //update the view
    static void updateColorView(final Activity activity, final View colorView, final TextView hashtext, final TextView hashtag, final TextView rgb, final EditText editHEX, final EditText editR, final EditText editG, final EditText editB, final int RGB) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                applyTextColor(activity, colorDialog.getComplementaryColor(RGB), hashtext, hashtag, rgb);
    ...
    static void updateColorOnResume(final Activity activity, final View colorView, final TextView hashtext, final TextView hashtag, final TextView rgb, final EditText editHEX, final EditText editR, final EditText editG, final EditText editB, final String erre, final String gi, final String bi, final int RGB) {
    ...
    //update the shit
    static void updateShitView(final Activity activity, final View colorView, final TextView hashtext, final TextView hashtag, final TextView rgb, final EditText editHEX, final EditText editR, final EditText editG, final EditText editB, final SeekBar first, final SeekBar second, final SeekBar third, final int RGB) {
