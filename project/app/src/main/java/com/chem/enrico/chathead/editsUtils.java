...
class editsUtils {
    ...
    static void initializeEditTextChangeListeners(TextWatcher hexTextWatcher, TextWatcher rTextWatcher, TextWatcher gTextWatcher, TextWatcher bTextWatcher, final EditText editHEX, final EditText editR, final EditText editG, final EditText editB) {
