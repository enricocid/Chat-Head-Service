...
class paletteUtils {
    ...
    static void initializeMaterialPalette(final Activity activity, Resources resources, final View colorView, final TextView hashtext, final TextView hashtag, final TextView rgb, final EditText editHEX, final EditText editR, final EditText editG, final EditText editB, ImageView... imageViews) {
        ...
        for (ImageView circles : imageViews) {
            ...
            circles.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    viewUtils.updateColorView(activity, colorView, hashtext, hashtag, rgb, editHEX, editR, editG, editB, color);
