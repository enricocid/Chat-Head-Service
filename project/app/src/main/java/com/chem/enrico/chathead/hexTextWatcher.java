...
class hexTextWatcher implements TextWatcher {
    ...
    hexTextWatcher(Activity a, final View cw, final TextView ht, final TextView htg, final TextView erregibi, final EditText hex, final EditText r, final EditText g, final EditText b, final SeekBar one, final SeekBar two, final SeekBar three) {
    ...
    public void onTextChanged(CharSequence s, int start, int before,
        ...
        try {
            ...
            viewUtils.updateShitView(activity, colorView, hashtext, hashtag, rgb, editHEX, editR, editG, editB, first, second, third, color);
